...
@HiltWorker
class EndDayWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        sessionActionHandler.endDay(scheduledIntakeId, intakeTimeId, NotificationContracts.occurrenceDateOf(occurrenceDateEpochDay))
